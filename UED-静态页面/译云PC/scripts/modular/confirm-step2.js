$(function(){
  ...
  $(document).on('click','[ok]',function(){
    ...
    var trans1 = [],
        trans2 =[];
    var parentL = $(this).parents('.addLanguage').parent();
    $(parentL.find('.inputLang')).each(function(){
        trans1.push($(this).text());
    });
    $(parentL.find('.inputType')).each(function(){
        trans2.push($(this).text());
    });
    console.log(trans1);
    console.log(trans2);
